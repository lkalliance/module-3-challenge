...
const lengthError = [
    ...
    "No, no, no, no, no, no, no. Your password must have more characters than the number of no's I put in that sentence. And no more than 128. I'm not typing all of those, my fingers are tired from wagging. Try again.",
    ...
    "Do you want to know a secret? I can only create passwords between 8 and 128 characters long. Let's keep this between us, OK? Just choose a length between 8 and 128 this time, and mum's the word. Try again.",
...
const numberError = [
    ...
    "You know that's not really a number. I know you know that's not really a number. You know I know you know that's not really a number. Try again, this time with a number espressed in digits, between 8 and 128.",
    ...
    "The quick brown fox jumped over the lazy dogs. Nothing in that sentence should be used when telling me your new password length. Just the digits 0 through 9 in some combination. Between 8 and 128. Try again.",
    ...
    "I'm a computer. I can only do what I've been told to do. And I've been told to only accept numbers expressed as digits for the password length, from 8 to 128. And to occasionally be sarcastic. Please try again.",
